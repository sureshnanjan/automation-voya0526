...
const response: ApiResponse[] = [{code: 200, type: "error", message: "successful operation"},
    {code: 400, type: "success", message: "operation failed"},
    {code: 200, type: "success", message: "successful operation"},
    {code: 404, type: "error", message: "not found"}, 

]; 
function responseHandler(response: ApiResponse  ) {
